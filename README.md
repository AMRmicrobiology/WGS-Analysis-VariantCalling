...
main: [main_clinal.nf](WGS-Analysis-VariantCalling/main_clinial.nf) includes the pipeline for de novo assembly; [main_reference.nf](WGS-Analysis-VariantCalling/main_reference.nf) includes the pipeline for analysis using a reference genome.
