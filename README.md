...
│--outdir&emsp;&nbsp;&nbsp;Directory where the results will be stored (default: out).

--mrsa&emsp;&nbsp;&nbsp;&nbsp;&nbsp;(only for --mode assemble): Specific for *Staphylococcus aureus* genome asseblies. It performs the [spaTyper](https://github.com/HCGB-IGTP/spaTyper) and [sccmec](https://github.com/rpetit3/sccmec) software analysis (dafault: false).
