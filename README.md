...
main: [main_clinical.nf](main_clinical.nf) includes the pipeline for de novo assembly; [main_reference.nf](main_reference.nf) includes the pipeline for analysis using a reference genome.
